							...
							new CommandResultFilter(connectCommandEvent), new BaseEventBotAction(ctx) {
								...
								protected void doRun(Event event, EventListener executingListener) {
									...
									if (!connectionMessageCommandResultEvent.isSuccess()) {
										...
										logger.info("Add an established connection "
												+ connectCommandEvent.getLocalSocket() + " -> "
												+ connectCommandEvent.getTargetSocket() + " to the botcontext ");
										botContextWrapper.addConnectedSocket(connectCommandEvent.getLocalSocket(),
